...
- Prevented same-second, same-title checkpoint saves from overwriting an earlier snapshot.
- Preserved the previous installed skills in a timestamped backup before upgrades.
- Rejected using the source repository itself as the install target.
